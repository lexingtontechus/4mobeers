...
export default function Hero() {
  return (
    <>
      <div id="hero">
        <h1 className="my-8 animate-linear bg-gradient-to-r from-trueFushia-500 via-trueZinc-900 to-trueFushia-500 bg-[length:200%_auto] bg-clip-text text-center text-8xl font-black uppercase text-transparent xl:text-9xl">
          4 Mo Beers!
        </h1>
        <div className="align-center visible flex place-content-center items-center">
          <Player
            autoplay
            loop
            src="https://storage.fleek.zone/ead18a13-670a-4701-91a7-06a767c3dcd5-bucket/assets/lottie/herocheers.json"
            style={{ height: "300px", width: "300px" }}
          ></Player>
        </div>

        {/*<div className="align=centervisible flex place-content-center items-center">
