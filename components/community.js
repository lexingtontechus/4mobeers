...
export default function Community() {
  ...
  return (
    <div id="community" className="my-8">
      <h1 className="animate-linear bg-gradient-to-r from-trueEmerald-500 via-trueFushia-500 to-trueEmerald-500 bg-[length:200%_auto] bg-clip-text text-center text-8xl font-black uppercase text-transparent xl:text-9xl">
        Community
      </h1>
      {/*{status == "connected" ? (*/}
        ...
        <div className="flex-grow text-center lg:text-left">
          <div>
            <h2 className="text-2xl font-medium uppercase text-trueZinc-700 dark:text-truePink-400 lg:text-3xl">
              {isConnected ? <>Join Our Discord</> : <>Connect Your Wallet</>}
            </h2>
          </div>
