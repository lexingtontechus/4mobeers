...
export default function Partner() {
  return (
    <div id="partners" className="my-8">
      <h1 className="animate-linear bg-gradient-to-r from-truePurple-500 via-trueAmber-500 to-truePurple-500 bg-[length:200%_auto] bg-clip-text text-center text-8xl font-black uppercase text-transparent xl:text-9xl">
        Partners
      </h1>
