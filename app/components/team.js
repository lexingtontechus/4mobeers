...
const Team = () => (
  <div id="team" className="m-8">
    <h1 className=" animate-linear bg-gradient-to-r from-trueRed-500 via-trueEmerald-500 to-truePink-500 bg-[length:200%_auto] bg-clip-text text-center text-5xl font-black uppercase text-transparent xl:text-5xl">
      Team
    </h1>
    <h2 className="text-trueZinc-500 text-center text-5xl font-black uppercase xl:text-6xl">
      Roadie Crew
    </h2>
    <div className="mt-8 flex flex-wrap">
      <div className="mb-12 w-full px-4 py-4 md:w-6/12 lg:mb-0 lg:w-3/12">
        ...
        />
        <h3 className="text-center text-3xl text-secondary-900">Mo Beers</h3>
        <p className="text-center text-2xl text-truePink-600 dark:text-truePink-400">
          Beer Shark
        </p>
        <p className="text-center text-xl text-primary-700 dark:text-primary-400">
      ...
      <div className="mb-12 w-full px-4 py-4 md:w-6/12 lg:mb-0 lg:w-3/12">
        ...
        />
        <h3 className="text-center text-3xl text-secondary-900">K Monster</h3>
        <p className="text-center text-2xl text-truePink-600 dark:text-truePink-400">
          The Wrangler
        </p>
        <p className="text-center text-xl text-primary-700 dark:text-primary-400">
      ...
      <div className="mb-12 w-full px-4 py-4 md:w-6/12 lg:mb-0 lg:w-3/12">
        <Image
          ...
          className="mx-auto animate-bounce border-2 p-2"
        />
        <h3 className="text-center text-3xl text-secondary-900">D</h3>
        <p className="text-center text-2xl text-truePink-600 dark:text-truePink-400">
          Roadie King
        </p>
        <p className="text-center text-xl text-primary-700 dark:text-primary-400">
      ...
      <div className="mb-12 w-full px-4 py-4 md:w-6/12 lg:mb-0 lg:w-3/12">
        <Image
          ...
          className="mx-auto animate-bounce border-2 p-2"
        />
        <h3 className="text-center text-3xl text-secondary-900">
          The Rock God
        </h3>
        <p className="text-center text-2xl text-truePink-600 dark:text-truePink-400">
          Vibe Machine
