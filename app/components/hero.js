...
export default function Hero() {
  return (
    <>
      <div id="hero" className="min-h-96 m-8">
        <h1 className="animate-linear bg-gradient-to-r from-trueFuchsia-500 via-trueZinc-900 to-trueBlue-500 bg-[length:200%_auto] bg-clip-text text-center text-8xl font-black uppercase text-transparent xl:text-9xl">
          4 Mo Beers!
        </h1>
