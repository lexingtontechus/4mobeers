  ...
  return (
    <>
      <div className="h-full w-full">
        ...
        <div className="container mx-auto flex w-10/12 flex-wrap place-content-center p-8">
          <div className="left-0 flex h-full min-h-[250px] w-full flex-col  overflow-hidden rounded-md border border-primary-300 bg-white shadow-2xl dark:border-primary-800 sm:max-h-[calc(100vh-120px)] lg:w-1/2">
            <div className="flex flex-col justify-center bg-secondary-600 pb-2">
              <Player
                autoplay
                loop
                src="https://storage.fleek-internal.com/ead18a13-670a-4701-91a7-06a767c3dcd5-bucket/assets/lottie/handstypingonkeyboard.json"
                style={{ height: '250px', width: '250px' }}
              ></Player>
              <h3 className="text-center text-lg text-primary-100">
                How can we help you?
              </h3>
              <p className="text-center text-primary-100 opacity-50">
              ...
              {!isSubmitSuccessful && (
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                  ...
                  <div className="mb-3">
                    <button
                      type="submit"
                      className="w-full rounded-md bg-secondary-500 px-3 py-4 text-primary-100 focus:bg-secondary-600 focus:outline-none"
                    >
                      {isSubmitting ? (
                        <svg
                          className="mx-auto h-5 w-5 animate-spin text-primary-100"
              ...
              {isSubmitSuccessful && isSuccess && (
                <>
                  <div className="flex h-full flex-col items-center justify-center rounded-md text-center text-primary-100">
                    ...
                    <button
                      className="mt-6 text-secondary-600 focus:outline-none"
                      onClick={() => reset()}
                    >
                      Go back
                    </button>
