 ...
 return (
  <>
    <main className="mx-auto">
      ...
      <div className="container relative mx-auto">
       <div className="flex flex-wrap items-center">
        <div className="mx-auto w-full px-4 text-center">
         <div className="h1 text-5xl font-semibold uppercase">
          Terms & Conditions
         </div>
     ...
     <section className="relative p-4 mb-8">
       ...
       <div className="flex flex-wrap items-center">
        <div className="ml-auto mr-auto w-full px-4">
         <div className="text-sm">
          ...
          and agree to be bound by all of these Terms of Use. IF YOU
          ...
          of Use are posted. The information provided on the Site is
          ...
          are applicable. The Site is not tailored to comply with
          ...
          be subjected to such laws, you may not use this Site. You
          may not use the Site in a way that would violate the
          Gramm-Leach-Bliley Act (GLBA). The Site is intended for
          users who are at least 18 years old. Persons under the age
          of 18 are not permitted to use or register for the Site or
          use the Marketplace Offerings.
         </div>
        </div>
      <div tabIndex={0} className="focus:bg-secondary collapse-arrow collapse my-2 rounded-md bg-accent text-primary-content focus:text-secondary-content"
        >
         ...
         <div className="collapse-content text-xs">
          ...
          <p>The Content and the Marks are provided on the Site “AS IS”
           ...
           our express prior written permission. Provided that you
      ...
      <div tabIndex={1} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>By using the Site or the Marketplace Offerings, you
           ...
           reside; (3) you will not access the Site or the
           Marketplace Offerings through automated or non-human
           ...
           Offerings will not violate any applicable law or
           ...
           thereof). You may not use the Site or the Marketplace
           Offerings for any illegal or unauthorized purpose nor may
           you, in the use of Marketplace Offerings, violate any
           laws. Among unauthorized Marketplace Offerings are the
           following: intoxicants of any sort; illegal drugs or other
           illegal products; alcoholic beverages; games of chance;
           and pornography or graphic adult content, images, or other
           adult products. Postings of any unauthorized products or
           content may result in immediate termination of your
           ...
           informational and advertising purposes only.</p>
        <p>We reserve the right to limit the quantities of the
           ...
           Offerings purchased by you will meet your expectations or
           that any errors in the Site will be corrected.</p>
       </div>
      </div>
     <div tabIndex={2} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p> We accept the following forms of payment: Crypto-Currency
           Bank Wire Transfer Visa Mastercard</p>
   ...
   <div tabIndex={6} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>You may not access or use the Site for any purpose other
           ...
           approved by us. As a user of the Site, you agree not to:</p>
  ...
  <div tabIndex={7} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p> The Site does not offer users to submit or post content.
           ...
           or make available any Contributions, you thereby represent
           and warrant that:</p>
         <ol>
           <li className="text-sm">
    ...
    <div tabIndex={8} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       CONTRIBUTION LICENSE
       </div>
       <div className="collapse-content text-xs"> 
        <p> You and the Site agree that we may access, store, process,
    ...
    <div tabIndex={9} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>As part of the functionality of the Site, you may link
           ...
           picture that become associated with your account.</p>
      </div>
      </div>
   <div tabIndex={10} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>You acknowledge and agree that any questions, comments,
    ...
    <div tabIndex={11} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>We reserve the right, but not the obligation, to: (1)
    ...
    <div tabIndex={12} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       ...
       <div className="collapse-content text-xs"> 
        <p>We care about data privacy and security. Please review our
           <span><Link href="https://4MoBeers.nft/privacy">Privacy Policy</Link></span> </p>
           <p>By using the
           ...
           Marketplace Offerings are hosted in the United States. If
           you access the Site or the Marketplace Offerings from any
           ...
           transferring your data to the United States, and you agree
           to have your data transferred to and processed in the
           United States.</p>  
       </div>
      </div>
   <div tabIndex={13} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       TERM AND TERMINATION
       </div>
       <div className="collapse-content text-xs"> 
        <p>These Terms of Use shall remain in full force and effect
           ...
           DENY ACCESS TO AND USE OF THE SITE AND THE MARKETPLACE
           ...
           OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR
           USE OR PARTICIPATION IN THE SITE AND THE MARKETPLACE
           OFFERINGS OR DELETE ANY CONTENT OR INFORMATION THAT YOU
  ...
  <div tabIndex={14} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       MODIFICATIONS AND INTERRUPTIONS
       </div>
       <div className="collapse-content text-xs"> 
        <p>We reserve the right to change, modify, or remove the
           ...
           of the Site or the Marketplace Offerings. We cannot
           guarantee the Site and the Marketplace Offerings will be
           available at all times. We may experience hardware,
           software, or other problems or need to perform maintenance
           related to the Site, resulting in interruptions, delays,
           or errors. We reserve the right to change, revise, update,
           suspend, discontinue, or otherwise modify the Site or the
           Marketplace Offerings at any time or for any reason
           without notice to you. You agree that we have no liability
           whatsoever for any loss, damage, or inconvenience caused
           by your inability to access or use the Site or the
           Marketplace Offerings during any downtime or
           discontinuance of the Site or the Marketplace Offerings.
           Nothing in these Terms of Use will be construed to
           obligate us to maintain and support the Site or the
           Marketplace Offerings or to supply any corrections,
           updates, or releases in connection therewith. GOVERNING
           LAW These Terms of Use and your use of the Site and the
           ...
           within the State of Delaware, without regard to its
           conflict of law principles.</p>
        
       </div>
      </div>
    <div tabIndex={15} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       DISPUTE RESOLUTION
       </div>
       <div className="collapse-content text-xs"> 
        <h3>Informal Negotiations</h3>
        <p>To expedite resolution and control the cost of any
        ...
        <p>If the Parties are unable to resolve a Dispute through
           ...
           in United States of America, Delaware. Except as otherwise
           ...
           award entered by the arbitrator. If for any reason, a
           Dispute proceeds in court rather than arbitration, the
           Dispute shall be commenced or prosecuted in the state and
           federal courts located in United States of America,
           Delaware, and the Parties hereby consent to, and waive all
           ...
           <h3>Restrictions</h3>
           <p> The Parties agree that any arbitration shall be limited to
           ...
           behalf of the general public or any other persons.</p>
           <h3>Exceptions to Informal Negotiations and Arbitration</h3>
           <p>The Parties agree that the following Disputes are not
  ...
  <div tabIndex={16} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       CORRECTIONS
       </div>
       <div className="collapse-content text-xs"> 
        <p> There may be information on the Site that contains
           typographical errors, inaccuracies, or omissions that may
           relate to the Marketplace Offerings, including
  ...
  <div tabIndex={17} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       DISCLAIMER
       </div>
       <div className="collapse-content text-xs"> 
        <p>THE SITE AND THE MARKETPLACE OFFERINGS ARE PROVIDED ON AN
           AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF
           THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO
           ...
           SITE OR THE MARKETPLACE OFFERINGS, (5) ANY BUGS, VIRUSES,
           TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR
           THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS
  ...
  <div tabIndex={18} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       LIMITATIONS OF LIABILITY
       </div>
       <div className="collapse-content text-xs"> 
        <p>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS
           ...
           THE SITE OR THE MARKETPLACE OFFERINGS, EVEN IF WE HAVE
           ...
           ARISING. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO
           ...
           ADDITIONAL RIGHTS. INDEMNIFICATION You agree to defend,
           ...
           Marketplace Offerings; (2) breach of these Terms of Use;
           ...
           toward any other user of the Site or the Marketplace
           Offerings with whom you connected via the Site.
           ...
           relating to your use of the Marketplace Offerings.
           ...
           Marketplace Offerings. You agree that we shall have no
           ...
           CALIFORNIA USERS AND RESIDENTS If any complaint with us is
           ...
           (916) 445-1254. MISCELLANEOUS These Terms of Use and any
           policies or operating rules posted by us on the Site or in
           respect to the Marketplace Offerings constitute the entire
           ...
           you may have based on the electronic form of these Terms
           of Use and the lack of signing by the parties hereto to
           execute these Terms of Use.</p>
        
       </div>
      </div>

    <div tabIndex={19} className="collapse collapse-arrow bg-accent text-primary-content focus:bg-secondary focus:text-secondary-content my-2 rounded-md">
       <div className="collapse-title">
       CONTACT US
       </div>
       <div className="collapse-content text-xs"> 
        <p> In order to resolve a complaint regarding the Site or the
